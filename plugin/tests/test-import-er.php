...
class ERImportTest extends WP_UnitTestCase {
	...
	function get_er_post_with_sections() {
	$post = $this->factory->post->create_and_get(array(
			...
			"post_content" => "<div class=\"item ERName\"><img class=\"alignnone size-large wp-image-10886\" src=\"http://test1.recipeproplugin.com/wp-content/uploads/2016/09/AMAZING-1-Bowl-Banana-Bread-Cinnamon-Rolls-9-ingredients-fast-and-entirely-vegan-683x1024.jpg\" alt=\"amazing-1-bowl-banana-bread-cinnamon-rolls-9-ingredients-fast-and-entirely-vegan\" width=\"683\" height=\"1024\" /></div>
		 	...
		 	<li class=\"ERSeparator\">DRY</li>
 	<li class=\"ingredient\">3 1/4 cups rolled oats (GF for gluten free eaters)</li>
 	<li class=\"ERSeparator\">WET</li>
 	<li class=\"ingredient\">1/4 cup coconut or olive oil</li>
 	</ul>
				</div>
	...
	function get_test_recipe_with_sections_json() {
		return '
			{
				...
				"ingredientSections": [
					{
						"name": "DRY",
						"items": [
							{"quantity":"", "unit":"", "name":"", "description":"3 1/4 cups rolled oats (GF for gluten free eaters)"}
						]
					},
					{
						"name": "WET",
						"items": [
							{"quantity":"", "unit":"", "name":"", "description":"1/4 cup coconut or olive oil"}
						]
					}
				],
				"instructions": [
