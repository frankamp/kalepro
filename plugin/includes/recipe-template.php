...
<?php endforeach; ?>
	...
	<div class="rp-detailsafter">
		<span class="rp-author"><?= $labels['author'] ?>: <span itemprop="author"><?= $recipe->author ?></span></span>
		<span class="rp-recipetype"><?= $labels['recipe_type'] ?>: <span itemprop="recipeCategory"><?= $recipe->type ?></span></span>
	</div>
</div>