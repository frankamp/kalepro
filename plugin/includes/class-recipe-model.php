...
class Recipe_Pro_Recipe_View_Helper {
	...
	public static function ldjson($recipe) {
		...
		if ($recipe->servingSize) $json_object['nutrition']['servingSize'] = $recipe->servingSize;
		if ($recipe->calories) $json_object['nutrition']['calories'] = $recipe->calories . " calories";
		if ($recipe->fatContent) $json_object['nutrition']['fatContent'] = $recipe->fatContent . " g";
		if ($recipe->transFatContent) $json_object['nutrition']['transFatContent'] = $recipe->transFatContent . " g";
		if ($recipe->cholesterolContent) $json_object['nutrition']['cholesterolContent'] = $recipe->cholesterolContent . " mg";
		if ($recipe->saturatedFatContent) $json_object['nutrition']['saturatedFatContent'] = $recipe->saturatedFatContent . " g";
		if ($recipe->unsaturatedFatContent) $json_object['nutrition']['unsaturatedFatContent'] = $recipe->unsaturatedFatContent . " g";
		if ($recipe->carbohydrateContent) $json_object['nutrition']['carbohydrateContent'] = $recipe->carbohydrateContent . " g";
		if ($recipe->sugarContent) $json_object['nutrition']['sugarContent'] = $recipe->sugarContent . " g";
...
class Recipe_Pro_Recipe implements JsonSerializable {
	...
	public function __construct() {
		...
		$this->servingSize = "";
		$this->calories = null;
		$this->cholesterolContent = null;
		$this->fatContent = null;
		$this->transFatContent = null;
		$this->saturatedFatContent = null;
		$this->unsaturatedFatContent = null;
		$this->carbohydrateContent = null;
		$this->sugarContent = null;
		$this->sodiumContent = null;
		$this->fiberContent = null;
		$this->proteinContent = null;
